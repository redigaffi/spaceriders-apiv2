...
class WebsocketController:
    ...
    async def trade_fetch_historical_data(self, market_code: str):
        return await self.trading_use_case.fetch_historical_data(market_code)
    ...
    async def trade_fetch_current_candle(self, market_code: str):
        return await self.trading_use_case.fetch_current_candle_data(market_code)
