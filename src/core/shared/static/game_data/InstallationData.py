    ...
    __ITEMS = {
        ...
        HANGAR: BuildableItemBaseType(
            ...
            "Hangar is needed in order to build and store spaceships and defense",
            {
                ...
                4: BuildableItemLevelInfo(
                    4,    250,    400,      100,    0,      0,    0,  2300,   0,      0,  40,     [
                        BuildableItemRequirement(TYPE, INVESTIGATION_LABORATORY, 4)], 0
                ),
                5: BuildableItemLevelInfo(
                    5,    300,    500,      120,    0,      0,    0,  2600,   0,      0,  50,     [
                        BuildableItemRequirement(TYPE, INVESTIGATION_LABORATORY, 5)], 0
                ),
                6: BuildableItemLevelInfo(
                    6,    350,    600,      140,    0,      0,    0,  2800,   0,      0,  60,     [
                        BuildableItemRequirement(TYPE, INVESTIGATION_LABORATORY, 6)], 0
                ),
                7: BuildableItemLevelInfo(
                    7,    400,    700,      150,    0,      0,    0,  3200,   0,      0,  80,     [
                        BuildableItemRequirement(TYPE, INVESTIGATION_LABORATORY, 7)], 0
                ),
                8: BuildableItemLevelInfo(
                    8,    450,    800,      200,    0,      0,    0,  3600,   0,      0,  100,     [
                        BuildableItemRequirement(TYPE, INVESTIGATION_LABORATORY, 8)], 0
                ),
                9: BuildableItemLevelInfo(
                    9,    550,    900,      250,    0,      0,    0,  4000,   0,      0,  150,     [
                        BuildableItemRequirement(TYPE, INVESTIGATION_LABORATORY, 9)], 0
                ),
                10: BuildableItemLevelInfo(
                    10,   700,    1000,      350,    0,      0,    0,  4800,   0,      0,  250,     [
                        BuildableItemRequirement(TYPE, INVESTIGATION_LABORATORY, 10)], 0
                ),
            },
        ),
    }
