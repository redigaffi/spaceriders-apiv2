...
class InstallationData(GameData):
    ...
    __ITEMS = {
        ...
        INVESTIGATION_LABORATORY: BuildableItemBaseType("Investigation Laboratory", INVESTIGATION_LABORATORY, TYPE, None,
                                                        "Investigation laboratory is needed in order to conduct new research",
                                                        {
                                                            0: BuildableItemLevelInfo(),
                                                            1: BuildableItemLevelInfo(1, 100, 0, 60, 0, 0, 0, 1200, 0,
                                                                                      0, 10,
                                                                                      [],
                                                                                      0),
                                                        }
        ...
        HANGAR: BuildableItemBaseType("Hangar", HANGAR, TYPE, None,
    ...
    def get_item(key: str) -> BuildableItemBaseType:
        if key not in InstallationData.TYPES:
            raise ValueError(f"{key} not in {InstallationData.TYPES} for {InstallationData.TYPE}")
