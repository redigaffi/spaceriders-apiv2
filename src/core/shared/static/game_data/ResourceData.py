...
class ResourceData(GameData):
    ...
    __ITEMS = {
        ...
        CRYSTAL_MINE: BuildableItemBaseType("Crystal Mine", CRYSTAL_MINE, TYPE, MINE_CATEGORY,  "Crystal mine to extract metal",
                                            {
                                                ...
                                                1: BuildableItemLevelInfo(1, 100, 100, 0, 1, 2, 0, 1200, 500, 0, 0, [], 0),
        ...
        PETROL_MINE: BuildableItemBaseType("Petrol Mine", PETROL_MINE, TYPE, MINE_CATEGORY, "Petrol mine to extract metal",
                                           {
                                               ...
                                               1: BuildableItemLevelInfo(1, 100, 10, 60, 1, 5, 0, 1200, 500, 0, 0, [], 0),
        ...
        METAL_WAREHOUSE: BuildableItemBaseType("Metal Warehouse", METAL_WAREHOUSE, TYPE, WAREHOUSE_CATEGORY,
                                               ...
                                               {
                                                   0: BuildableItemLevelInfo(0, 100, 50, 60, 0, 0, 0, 1200, 10, 0, 0, [],
                                                                             0),
                                                   1: BuildableItemLevelInfo(1, 120, 100, 80, 0, 0, 500, 10, 30, 0, 0, [],
                                                                             0),

                                                   2: BuildableItemLevelInfo(1, 140, 300, 90, 0, 0, 700, 30, 100, 0, 0, [],
                                                                             0),
                                                   3: BuildableItemLevelInfo(1, 180, 350, 100, 0, 0, 900, 60, 150, 0, 0, [],
                                                                             0),
                                                   4: BuildableItemLevelInfo(1, 250, 450, 150, 0, 0, 2000, 120, 200, 0, 0, [],
                                                                             0),
                                                   5: BuildableItemLevelInfo(1, 3000, 600, 600, 0, 0, 4000, 1000, 500, 0, 0, [],
                                                                             0),
                                                   6: BuildableItemLevelInfo(1, 3500, 700, 650, 0, 0, 4100, 1300, 600, 0, 0, [],
                                                                             0),
                                                   7: BuildableItemLevelInfo(1, 4000, 800, 900, 0, 0, 4500, 1800, 600, 0, 0, [],
                                                                             0),
                                                   8: BuildableItemLevelInfo(1, 5000, 1000, 1000, 0, 0, 5000, 2000, 800, 0, 0, [],
                                                                             0),

                                                   9: BuildableItemLevelInfo(1, 100, 0, 60, 0, 0, 500, 2500, 900, 0, 0, [],
                                                                             0),

                                                   10: BuildableItemLevelInfo(1, 100, 0, 60, 0, 0, 500, 3500, 900, 0, 0, [],
                                                                             0),
        ...
        CRYSTAL_WAREHOUSE: BuildableItemBaseType("Crystal Warehouse", CRYSTAL_WAREHOUSE, TYPE, WAREHOUSE_CATEGORY,
                                                 "Crystal warehouse to store crystal",
                                                 {
                                                     ...
                                                     2: BuildableItemLevelInfo(1, 140, 300, 90, 0, 0, 700, 30, 100, 0,
                                                                               0, [],
                                                                               0),
                                                     3: BuildableItemLevelInfo(1, 180, 350, 100, 0, 0, 900, 60, 150, 0,
                                                                               0, [],
                                                                               0),
                                                     4: BuildableItemLevelInfo(1, 250, 450, 150, 0, 0, 2000, 120, 200,
                                                                               0, 0, [],
                                                                               0),
                                                     5: BuildableItemLevelInfo(1, 3000, 600, 600, 0, 0, 4000, 1000, 500,
                                                                               0, 0, [],
                                                                               0),
                                                     6: BuildableItemLevelInfo(1, 3500, 700, 650, 0, 0, 4100, 1300, 600,
                                                                               0, 0, [],
                                                                               0),
                                                     7: BuildableItemLevelInfo(1, 4000, 800, 900, 0, 0, 4500, 1800, 600,
                                                                               0, 0, [],
                                                                               0),
                                                     8: BuildableItemLevelInfo(1, 5000, 1000, 1000, 0, 0, 5000, 2000,
                                                                               800, 0, 0, [],
                                                                               0),

                                                     9: BuildableItemLevelInfo(1, 100, 0, 60, 0, 0, 500, 2500, 900, 0,
                                                                               0, [],
                                                                               0),

                                                     10: BuildableItemLevelInfo(1, 100, 0, 60, 0, 0, 500, 3500, 900, 0,
                                                                                0, [],
                                                                                0),
                                                 }
                                                 ),
        PETROL_WAREHOUSE: BuildableItemBaseType("Petrol Warehouse", PETROL_WAREHOUSE, TYPE, WAREHOUSE_CATEGORY,
                                                "Petrol warehouse to store petrol",
                                                {
                                                    ...
                                                    3: BuildableItemLevelInfo(1, 180, 350, 100, 0, 0, 900, 60, 150, 0,
                                                                              0, [],
                                                                              0),
                                                    4: BuildableItemLevelInfo(1, 250, 450, 150, 0, 0, 2000, 120, 200, 0,
                                                                              0, [],
                                                                              0),
                                                    5: BuildableItemLevelInfo(1, 3000, 600, 600, 0, 0, 4000, 1000, 500,
                                                                              0, 0, [],
